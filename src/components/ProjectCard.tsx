...
function ProjectCard(props: { project: Project }) {
    ...
    return <div className="border-b-2 border-slate-200 dark:border-gray-800 p-4 flex flex-col gap-8 h-full md:content-between">
        <div className="flex flex-col md:flex-row gap-4">
            ...
            {project.mediaUrls != undefined && project.mediaUrls.length > 0 ?
                <img src={project.mediaUrls[0]} alt={project.name}
                className="w-full max-h-64 object-cover md:h-fit md:w-1/2 lg:w-1/3 md:object-contain rounded-lg float-right min-w-[200px]" /> : null}
        </div>
    </div>
}
